...
/**
     ...
     */
QByteArray UIKISSUtils::kissWrap(QByteArray in)
{
    /**
...
/**
     ...
     * @return - QByteArray of KISS wrapped data.
     */
QByteArray UIKISSUtils::kissWrapCommand(QByteArray val, int cmdCode)
{
    /**
     * The KISS "FEND" (frame end) character. One at each end of a KISS frame
     */
...
/**
     ...
     */
QByteArray UIKISSUtils::kissUnwrap(QByteArray in)
{
    /**
     * The KISS "FEND" (frame end) character. One at each end of a KISS frame
     */
